...
class RadioViewModel : ViewModel() {
    ...
    fun getRadio(){
        ...
        data.add(RadioData("https://radio-online.id/assets/image/radio/180/rri-1yogyakarta.jpg","RRI Pro Jogja", "https://stream-node0.rri.co.id/streaming/14/9014/kbrn.mp3"))
